...
class RegionProposalNetwork(nn.Module):
  ...
  def generate_anchors(self, image, feat):
    grid_h, grid_w = feat.shape[-2:]  # shape is [batch_size, in_channels, grid_h, grid_w]
  ...
  def assign_targets_to_anchors(self, anchors, gt_boxes):
    ...
    iou_matrix = get_iou(gt_boxes, anchors) # output should be #gt, #anchors, 
    ...
    # set all foreground labels as 1
